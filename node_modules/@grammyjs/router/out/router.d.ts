import { Middleware, MiddlewareObj, MiddlewareFn, Context } from './deps.node.js';
...
export declare class Router<C extends Context> implements MiddlewareObj<C> {
    ...
    routeHandlers: Map<string, Middleware<C>>;
     ...
     */
    constructor(router: (ctx: C) => MaybePromise<string | undefined>, routeHandlers?: Map<string, Middleware<C>>);
    /**
     ...
     */
    route(route: string, ...middleware: Array<Middleware<C>>): this;
    /**
     ...
     */
    otherwise(...middleware: Array<Middleware<C>>): this;
